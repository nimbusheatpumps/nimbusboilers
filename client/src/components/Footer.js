        ...
        <div className="section-container section-padding">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="bg-white/5 rounded-3xl p-8 md:p-12 border border-white/10 flex flex-col md:flex-row items-center gap-8 shadow-2xl">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-white font-black tracking-[0.2em] text-lg">#966812</p>
                </div>
              </div>
              <a
                ...
                aria-label="Verify Registration: Official Gas Safe Register #966812"
              >
                Verify Registration
              </a>
            </div>
            ...
            <div className="text-center lg:text-left space-y-6">
              ...
              <p className="text-slate-300 text-lg max-w-md mx-auto lg:mx-0">Expert boiler installation and repair services across Scunthorpe and North Lincolnshire.</p>
          ...
          <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-8">
            <p className="text-sm text-slate-200">&copy; 2025 Nimbus Boilers & Heat Pumps Ltd. All rights reserved.</p>
            <div className="flex gap-10">
              <Link to="/privacy-policy" className="text-sm text-slate-200 hover:text-white transition-colors font-medium">Privacy Policy</Link>
              <Link to="/terms-and-conditions" className="text-sm text-slate-200 hover:text-white transition-colors font-medium">Terms & Conditions</Link>
              <a href="https://x.com/NimbusHeatPumps" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-200 hover:text-white transition-colors font-medium">Twitter</a>
            </div>
          </div>
          <div className="mt-10 text-center">
            <p className="text-[11px] text-slate-300 uppercase tracking-[0.3em] font-bold">Calls recorded for training and quality purposes.</p>
          </div>
        </div>
      </footer>
    </>
